...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const map<unsigned int,map<string,int> >*)
   {
      ...
      ::ROOT::AddClassAlternate("map<unsigned int,map<string,int> >","std::map<unsigned int, std::map<std::string, int, std::less<std::string>, std::allocator<std::pair<std::string const, int> > >, std::less<unsigned int>, std::allocator<std::pair<unsigned int const, std::map<std::string, int, std::less<std::string>, std::allocator<std::pair<std::string const, int> > > > > >");
      return &instance;
   }
   // Static variable to force the class initialization
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const map<unsigned int,map<string,double> >*)
   {
      ...
      ::ROOT::AddClassAlternate("map<unsigned int,map<string,double> >","std::map<unsigned int, std::map<std::string, double, std::less<std::string>, std::allocator<std::pair<std::string const, double> > >, std::less<unsigned int>, std::allocator<std::pair<unsigned int const, std::map<std::string, double, std::less<std::string>, std::allocator<std::pair<std::string const, double> > > > > >");
      return &instance;
   }
   // Static variable to force the class initialization
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const map<unsigned int,map<string,bool> >*)
   {
      ...
      ::ROOT::AddClassAlternate("map<unsigned int,map<string,bool> >","std::map<unsigned int, std::map<std::string, bool, std::less<std::string>, std::allocator<std::pair<std::string const, bool> > >, std::less<unsigned int>, std::allocator<std::pair<unsigned int const, std::map<std::string, bool, std::less<std::string>, std::allocator<std::pair<std::string const, bool> > > > > >");
      return &instance;
   }
   // Static variable to force the class initialization
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const map<string,int>*)
   {
      ...
      ::ROOT::AddClassAlternate("map<string,int>","std::map<std::string, int, std::less<std::string>, std::allocator<std::pair<std::string const, int> > >");
      return &instance;
   }
   // Static variable to force the class initialization
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const map<string,double>*)
   {
      ...
      ::ROOT::AddClassAlternate("map<string,double>","std::map<std::string, double, std::less<std::string>, std::allocator<std::pair<std::string const, double> > >");
      return &instance;
   }
   // Static variable to force the class initialization
...
"external",
"/usr/include/root",
"/scratchfs/bes/myliu/Delphes-3.5.0/",
0
    };
